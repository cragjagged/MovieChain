    ...
    <div style={{
      ...
      <div style={{ padding: "16px 16px 14px", borderBottom: `1px solid ${T.border}` }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <svg width="38" height="38" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
          ...
          <div>
            <div style={{ fontSize: 15, fontWeight: 700, color: T.text1, letterSpacing: "-0.02em" }}>Movie Chain</div>
      ...
      {suggestedSequel && (
        <div style={{ borderTop: `1px solid ${T.border}` }}>
          <div style={{ overflow: "hidden" }}>
            <div style={{ height: 32, padding: "0 10px", background: T.bg3, borderBottom: `1px solid ${T.border}`, display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
